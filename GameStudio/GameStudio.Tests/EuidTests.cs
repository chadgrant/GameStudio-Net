...
namespace GameStudio.Tests
{
    public class EuidTests
    {
        ...
        {
            var id = EuidV1.Create(Studio.ThreeFortyThree, Application.MyVegasWeb, 1123453657);
        ...
        public void Can_Parse_EuidV1()
        {
            ...
            Assert.Equal(Studio.ThreeFortyThree, euid.Studio);
        ...
        public void Can_Create_Euid()
        {
            ...
            var id = Euid.Create(Studio.ThreeFortyThree,Application.MyVegasWeb, 11234, 1123453657,  dt, rand);
